...
class Tx:
    ...
    def is_coinbase(self):
        ...
        input = self.tx_ins[0]
        if input.prev_tx != b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00':
            return False
        return input.prev_index == 0xffffffff

...
class Block:
    ...
    def bip9(self):
        ...
        # that is 001
        # print(self.serialize() >> 29)
        # return (self.serialize() >> 29) == 0x1
    ...
    def bip91(self):
        ...
        # print(self.version >> 4)
        # return self.version >> 4 == 0b01
    ...
    def check_pow(self):
        ...
        h = little_endian_to_int(hash256(self.serialize()))
